...
import com.naitsc.viacep.api.Api
import com.naitsc.viacep.databinding.ActivityMainBinding
import com.naitsc.viacep.model.Endereco
import retrofit2.*
                ...
                retrofit.setEndereco(cep).enqueue(object : Callback<Endereco> {
                    override fun onResponse(call: Call<Endereco>, response: Response<Endereco>) {
                        if (response.code() == 200) {
                            ...
                            Toast.makeText(applicationContext, "Cep inválido!", Toast.LENGTH_SHORT)
                                .show()
                        }
                    }
